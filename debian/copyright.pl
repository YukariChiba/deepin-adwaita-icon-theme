...
open(LICENSE, 'debian/CC-BY-SA-3.0-Unported.license');
while(<LICENSE>) {
	s/^/ /;
	s/^ $/ ./;
	print;
...
open(LICENSE, 'debian/CC-BY-SA-4.0.license');
while(<LICENSE>) {
	s/^/ /;
	s/^ $/ ./;
	print;
...
open(LICENSE, 'debian/CC-BY-3.0-US.license');
while(<LICENSE>) {
	s/^/ /;
	s/^ $/ ./;
	print;
...
open(LICENSE, 'debian/CC-BY-SA-3.0-US.license');
while(<LICENSE>) {
	s/^/ /;
	s/^ $/ ./;
	print;
...
open(LICENSE, 'debian/CC-BY-SA-2.0-IT.license');
while(<LICENSE>) {
	s/^/ /;
	s/^ $/ ./;
	print;
